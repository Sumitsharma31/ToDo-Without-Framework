...
function printList() {
    ...
    for (let i = 0; i < todoList.length; i++) {
        ...
        <li class="todoElement"> ${element}<span class="btnSection">
          <button onclick="updateList(${i})"><img src="/ToDo-Without-Framework/sources/edit-4-svgrepo-com.svg" width="20px">
          </button>
          <button  onclick="deleteData(${i})"><img src="/ToDo-Without-Framework/sources/trash-bin-icon.svg" width="20px" alt="">
          </button></span>
       </li>
        `;
    }
